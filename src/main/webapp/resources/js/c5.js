		...
		(
				{
					1 : [
							function(t, e, i) {
													...
													},
													{
														...
														value : function i(t,
															...
															var o = arguments.length > 6
																	&& arguments[6] !== undefined ? arguments[6]
																	: undefined
														}
													},
													{
								...
								Object.defineProperty(a, "EVENTS", {
									writable : false,
									configurable : false,
									value : [ "AdLoaded", "AdStarted",
											"AdStopped", "AdSkipped",
											"AdSkippableStateChange",
											"AdSizeChange", "AdLinearChange",
											"AdDurationChange",
											"AdExpandedChange",
											"AdRemainingTimeChange",
											"AdVolumeChange", "AdImpression",
											"AdVideoStart",
											"AdVideoFirstQuartile",
											"AdVideoMidpoint",
											"AdVideoThirdQuartile",
											"AdVideoComplete", "AdClickThru",
											"AdInteraction",
											"AdUserAcceptInvitation",
											"AdUserMinimize", "AdUserClose",
											"AdPaused", "AdPlaying", "AdLog",
											"AdError" ]
								})
							}, {} ],
					2 : [
							function(t, e, i) {
								...
								function s(t, e) {
									...
									return e
											&& ((typeof e === "undefined" ? "undefined"
													: n(e)) === "object" || typeof e === "function") ? e
											: t
								}
								...
								var l = Object.getOwnPropertyNames(u.prototype)
										.filter(
												function(t) {
													return [ "constructor" ]
															.indexOf(t) === -1
								...
								var c = i.VPAIDAdUnit = function(t) {
									...
									function e(t) {
										a(this, e);
										var i = s(this, (e.__proto__ || Object
												.getPrototypeOf(e)).call(this));
										i._destroyed = false;
										i._flash = t;
										return i
									}
							...
							function(t, e, i) {
								...
								var g = function() {
									function t(e, i) {
										...
										h.movie = n.data;
										h.FlashVars = "flashid="
												+ this._flashID + "&handler="
												+ s.VPAID_FLASH_HANDLER
												+ "&debug=" + p.debug
												+ "&salign=" + h.salign;
										if (!t.isSupported()) {
											return m("user don't support flash or doesn't have the minimum required version of flash "
													+ v)
										}
										this.el = a.createSWF(n, h,
												this._flashID);
										if (!this.el) {
										...
										var g = l(p.timeout, function(t, e) {
											...
											i("vpaid flash load timeout "
													+ p.timeout)
										});
										this._flash = new s(this.el, n.data,
												this._flashID, n.width,
												n.height, g);
													...
													},
													{
														...
														value : function h() {
															...
															if (this._adUnitLoad) {
																...
																this._flash
																		.removeCallback(this._adUnitLoad)
															}
															if (this._adUnit) {
																this._adUnit
																		._destroy();
								...
								k("isSupported", function() {
									return a.hasFlashPlayerVersion(v)
											&& y.isSupported()
								}, true);
								...
								function m() {
									if (this._destroyed) {
										throw new Error(
												"VPAIDFlashToJS is destroyed!")
									}
								}

								function A() {
									if (this._loadLater) {
										this.loadAdUnit(this._loadLater.url,
												this._loadLater.callback);
										delete this._loadLater
									}
								}
							...
							function(t, e, i) {
								...
								var d = function() {
									function t(e) {
										...
										r(this, t);
										this.parentEl = l.createElementWithID(
												e, o);
										l.hideFlashEl(this.parentEl);
										var s = {};
										s.movie = n.data;
										s.FlashVars = "flashid=" + o
												+ "&handler="
												+ u.VPAID_FLASH_HANDLER;
													...
													},
													{
														...
														value : function L() {
															...
															this
																	.removeAllCallbacks();
															c
																	.removeInstanceByID(this._flashID);
					...
					9 : [
							function(t, e, i) {
								"use strict";
								var n = [ "handshakeVersion", "initAd",
										"startAd", "stopAd", "skipAd",
										"resizeAd", "pauseAd", "resumeAd",
										"expandAd", "collapseAd", "subscribe",
										"unsubscribe" ];
								var r = [ "AdLoaded", "AdStarted", "AdStopped",
										"AdSkipped", "AdSkippableStateChange",
										"AdSizeChange", "AdLinearChange",
										"AdDurationChange", "AdExpandedChange",
										"AdRemainingTimeChange",
										"AdVolumeChange", "AdImpression",
										"AdVideoStart", "AdVideoFirstQuartile",
										"AdVideoMidpoint",
										"AdVideoThirdQuartile",
										"AdVideoComplete", "AdClickThru",
										"AdInteraction",
										...
										"AdPaused", "AdPlaying", "AdLog",
										"AdError" ];
								var a = [ "getAdLinear", "getAdWidth",
										"getAdHeight", "getAdExpanded",
										"getAdSkippableState",
										"getAdRemainingTime", "getAdDuration",
										"getAdVolume", "getAdCompanions",
										"getAdIcons" ];
								var s = [ "setAdVolume" ];
								...
								o.prototype.initAd = function(t, e, i, n, r, a,
										s) {
								};
					...
					10 : [
							function(t, e, i) {
								...
								n.METHODS.forEach(function(t) {
									...
									d.prototype[t] = function() {
										...
										var i = Array.prototype.slice
												.call(arguments);
										var r = e === i.length ? i.pop()
												: undefined;
										setTimeout(function() {
											var e, n = null;
											try {
												e = this._creative[t].apply(
														this._creative, i)
											} catch (a) {
												n = a
											}
								...
								d.prototype.initAd = function g(t, e, i, n, r,
										a, o) {
									r = r || {};
									a = s.extend({
										slot : this._el,
								...
								function p(t) {
									this._subscribers
											.trigger(t, Array.prototype.slice(
													arguments, 1))
								}
					...
					11 : [
							function(t, e, i) {
								...
								function u(t, e, i, a) {
									...
									this._id = r();
									this._destroyed = false;
									this._frameContainer = n.createElementInEl(
											t, "div");
									this._videoEl = e;
								...
								u.prototype.loadAdUnit = function A(t, e) {
									...
									this._frame = r;
									this._onLoad = n.callbackTimeout(
											this._vpaidOptions.timeout, s
													.bind(this), u.bind(this));
									...
									function s(t) {
										...
										if (!u) {
											var d = i._frame.contentWindow.document
													.querySelector(".ad-element");
											s = new a(l(), d, i._videoEl,
													i._frame);
					...
					12 : [
							function(t, e, i) {
								...
								n.prototype.unsubscribe = function a(t, e) {
									this._subscribers[e] = this.get(e).filter(
											function(e) {
												return t !== e.handler
											})
								};
								...
								n.prototype.trigger = function(t, e) {
									...
									n.forEach(function(t) {
										setTimeout(function() {
											if (i.isHandlerAttached(t.handler,
													t.eventName)) {
										...
										(
												...
												function() {
													var t = "undefined", e = "object", i = "Shockwave Flash", n = "ShockwaveFlash.ShockwaveFlash", r = "application/x-shockwave-flash", a = "SWFObjectExprInst", s = "onreadystatechange", o = window, u = document, l = navigator, c = false, d = [], f = [], h = [], p = [], v, y, g, m, A = false, k = false, _, b, w = true, T = false, E = function() {
														var a = typeof u.getElementById !== t
																&& typeof u.getElementsByTagName !== t
																&& typeof u.createElement !== t, s = l.userAgent
																.toLowerCase(), d = l.platform
																.toLowerCase(), f = d ? /win/
																.test(d)
																: /win/.test(s), h = d ? /mac/
																.test(d)
																...
																.replace(
																		/^.*webkit\/(\d+(\.\d+)?).*$/,
																		"$1"))
																: false, v = l.appName === "Microsoft Internet Explorer", y = [
																0, 0, 0 ], g = null;
														if (typeof l.plugins !== t
																&& typeof l.plugins[i] === e) {
															g = l.plugins[i].description;
															if (g
																	&& (typeof l.mimeTypes !== t
																			&& l.mimeTypes[r] && l.mimeTypes[r].enabledPlugin)) {
																c = true;
																v = false;
																g = g
																		.replace(
													...
													function D(e, i, n, r) {
														...
														if (s) {
															...
															var l = E.ie ? "ActiveX"
																	: "PlugIn", c = "MMredirectURL="
																	+ encodeURIComponent(o.location
																			.toString()
																			.replace(
																					/&/g,
																					"%26"))
														...
														if (E.win && E.ie) {
															...
															if (n) {
																...
																if (r) {
																	var a = r.length;
																	for (var s = 0; s < a; s++) {
																		if (!(r[s].nodeType == 1 && r[s].nodeName === "PARAM")
																				&& !(r[s].nodeType == 8)) {
																			i
																					.appendChild(r[s]
																							.cloneNode(true))
													...
													function R(t, e) {
														var i = z("div");
														i.innerHTML = "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'><param name='movie' value='"
																+ t
																+ "'>"
																+ e
																+ "</object>";
													...
													function G(e) {
														...
														var n = i.exec(e) !== null;
														return n
																&& typeof encodeURIComponent !== t ? encodeURIComponent(e)
																: e
													}
													var K = function() {
														if (E.ie) {
																...
																C(function() {
																	...
																	if (u
																		...
																		for ( var m in u) {
																			if (u
																					.hasOwnProperty(m)) {
																				var A = T ? encodeURIComponent(m)
																						: m, k = T ? encodeURIComponent(u[m])
																						: u[m];
					...
					16 : [
							function(t, e, i) {
								...
								function o(t) {
									...
									this.creativeType = a.attr(
											t.staticResource, "creativeType");
									this.staticResource = a
											.keyValue(t.staticResource);
									s.info("<Companion>  creativeType: "
											+ this.creativeType);
									s.info("<Companion>  staticResource: "
											+ this.staticResource);
									var e = null;
									...
									if (i !== null) {
										s
												.info(
														"<Companion> found iframe resource",
														i)
									}
									...
									this.expandedWidth = a.attr(t,
											"expandedWidth");
									this.expandedHeight = a.attr(t,
											"expandedHeight");
									this.scalable = a.attr(t, "scalable");
									this.maintainAspectRatio = a.attr(t,
											"maintainAspectRatio");
									this.minSuggestedDuration = a.attr(t,
											"minSuggestedDuration");
									this.apiFramework = a.attr(t,
											"apiFramework");
									this.companionClickThrough = a
											.keyValue(t.companionClickThrough);
									this.trackingEvents = u(t.trackingEvents
											&& t.trackingEvents.tracking);
									s
											.info("<Companion>  companionClickThrough: "
					...
					17 : [
							function(t, e, i) {
								...
								function s(t) {
									...
									if (t.companionAds) {
										var e = [];
										var i = t.companionAds
												&& t.companionAds.companion;
										if (a.isDefined(i)) {
											i = a.isArray(i) ? i : [ i ];
											i.forEach(function(t) {
												e.push(new r(t))
								...
								s.parseCreatives = function o(t) {
									...
									var i;
									if (a.isDefined(t)
											&& a.isDefined(t.creative)) {
										i = a.isArray(t.creative) ? t.creative
												: [ t.creative ];
										i.forEach(function(t) {
											e.push(new s(t))
										})
					...
					18 : [
							function(t, e, i) {
								...
								function o(t) {
									...
									this.impressions = n
											.parseImpressions(t.impression);
									this.creatives = r
											.parseCreatives(t.creatives);
									this.description = s
											.keyValue(t.description);
					...
					19 : [
							function(t, e, i) {
								...
								function l(t) {
									...
									this.duration = o.duration(u
											.keyValue(t.duration));
									this.mediaFiles = i(t.mediaFiles
											&& t.mediaFiles.mediaFile);
									this.trackingEvents = e(t.trackingEvents
											&& t.trackingEvents.tracking,
											this.duration);
									this.skipoffset = o.offset(u.attr(t,
											"skipoffset"), this.duration);
									if (t.videoClicks) {
										this.videoClicks = new a(t.videoClicks)
									}
									if (t.adParameters) {
										this.adParameters = u
												.keyValue(t.adParameters);
										if (u
												.attr(t.adParameters,
														"xmlEncoded")) {
											this.adParameters = u
													.decode(this.adParameters)
										}
									}
					...
					20 : [
							function(t, e, i) {
								...
								var n = t("../../utils/xml");
								var r = t("./vastUtil");
								var a = [ "delivery", "type", "width",
										"height", "codec", "id", "bitrate",
										"minBitrate", "maxBitrate", "scalable",
										"maintainAspectRatio", "apiFramework" ];
								...
								s.prototype.isSupported = function() {
									if (r.isVPAID(this)) {
										return !!r
												.findSupportedVPAIDTech(this.type)
									}
					...
					22 : [
							function(t, e, i) {
								...
								f.prototype._getVASTAd = function(t, e) {
									...
									function s(t, e) {
										...
										try {
											...
											d
													.debug(
															"built JXONTree from VAST response:",
															i);
											if (l.isArray(i.ad)) {
												i.ads = i.ad
											} else if (i.ad) {
									...
									function p(t) {
										...
										if (i && e) {
											return new r(
													n
															+ "InLine and Wrapper both found on the same Ad",
													101)
										}
										if (!i && !e) {
											return new r(
										...
										if (e && !e.VASTAdTagURI) {
											return new r(
													n
															+ "missing 'VASTAdTagURI' in wrapper",
													101)
										}
										return null
									}
								...
								f.prototype._requestVASTXml = function p(t, e) {
									...
									function n(t, i, n) {
										if (t) {
											var a = l.isDefined(n) ? "on VASTClient.requestVastXML, HTTP request error with status '"
													+ n + "'"
					...
					24 : [
							function(t, e, i) {
								...
								f.prototype.playAd = function h(t, e) {
									...
									if (!(t instanceof n)) {
										return e(new r(
												"On VASTIntegrator, missing required VASTResponse"))
									}
									o.waterfall([ function(e) {
										e(null, t)
								...
								f.prototype._createVASTTracker = function v(t,
										e, i) {
									try {
								...
								f.prototype._setupEvents = function y(t, e, i,
										n) {
									var r;
									var a = this.player;
									...
									l.once(a,
											...
											s);
									l.once(a, [ "vast.adEnd", "vast.adsCancel",
											"vast.adSkip" ], function(t) {
								...
								f.prototype._addSkipButton = function g(t, e,
										i, n) {
									var r;
									var a = this;
								...
								f.prototype._addClickThrough = function m(t, e,
										i, n) {
									var r = this.player;
									var a = d(r, e, i);
								...
								f.prototype._playSelectedAd = function A(t, e,
										i) {
									var n = this.player;
									n.preload("auto");
									n.src(t);
									d
											.debug("<VASTIntegrator._playSelectedAd> waiting for durationchange to play the ad...");
									l
											.once(
													n,
													[ "durationchange",
													...
													function(t) {
														if (t.type === "durationchange") {
															d
																	.debug("<VASTIntegrator._playSelectedAd> got durationchange; calling playAd()");
															a()
									...
									function a() {
										l
												.once(
														...
														function(t) {
															...
															d
																	.debug("<VASTIntegrator._playSelectedAd/playAd> got playing event; triggering vast.adStart...");
															n
																	.trigger("vast.adStart");
															n.on("ended", r);
															n
																	.on(
																			"vast.adsCancel",
										...
										d
												.debug("<VASTIntegrator._playSelectedAd/playAd> calling player.play()...");
										n.play()
									}
								};
					...
					25 : [
							function(t, e, i) {
								...
								c.prototype._addErrorTrackUrl = function(t) {
									var e = t instanceof l.JXONTree ? l
											.keyValue(t) : t;
									if (e) {
								...
								c.prototype._addVideoClicks = function(t) {
									if (t instanceof r) {
										...
										this
												._addClickTrackings(t.clickTrackings);
								...
								c.prototype._addLinear = function(t) {
									if (t instanceof a) {
										...
										this
												._addTrackingEvents(t.trackingEvents);
									...
									if (t instanceof o) {
										...
										t.creatives
												.forEach(function(t) {
													...
													if (i) {
														e
																._addVideoClicks(i.videoClicks);
														e.clickThrough = undefined;
														e
																._addTrackingEvents(i.trackingEvents)
													}
												})
									}
								};
					...
					26 : [
							function(t, e, i) {
								...
								o.prototype.trackEvent = function l(t, e) {
									this
											.trackURLs(i(this.response.trackingEvents[t]));
									if (e) {
								...
								[ "rewind", "fullscreen", "exitFullscreen",
										"pause", "resume", "mute", "unmute",
										"acceptInvitation",
										"acceptInvitationLinear", "collapse",
										"expand" ]
										.forEach(function(t) {
											o.prototype["track"
													+ s.capitalize(t)] = function() {
												this.trackEvent(t)
											}
										});
								[ "start", "skip", "close", "closeLinear" ]
										.forEach(function(t) {
											o.prototype["track"
													+ s.capitalize(t)] = function() {
								...
								o.prototype.trackClick = function p() {
									this
											.trackURLs(this.response.clickTrackings)
								};
								e.exports = o
							}, {
								"../../utils/utilityFunctions" : 47,
							...
							function(t, e, i) {
								...
								function o(t) {
									...
									this.followAdditionalWrappers = a
											...
											.attr(t, "followAdditionalWrappers")
											: true;
									this.allowMultipleAds = s.attr(t,
											"allowMultipleAds");
									this.fallbackOnNoAd = s.attr(t,
											"fallbackOnNoAd")
								}
								e.exports = o
							}, {
							...
							function(t, e, i) {
								...
								var o = {
									...
									parseURLMacros : function l(t, e) {
										...
										e = e || {};
										if (!e["CACHEBUSTING"]) {
											e["CACHEBUSTING"] = Math.round(Math
													.random() * 1e10)
										}
										t.forEach(function(t) {
							...
							function(t, e, i) {
								...
								function a(t, e) {
									...
									function i(t, e) {
										...
										if (!("responseTimeout" in e)
												|| !r
														.isNumber(e.responseTimeout)) {
											throw new n(
								...
								a.checkVPAIDInterface = function s(t) {
									var e = [ "handshakeVersion", "initAd",
											"startAd", "stopAd", "resizeAd",
											"pauseAd", "expandAd", "collapseAd" ];
									...
									function a(t) {
										return r.isFunction(t.subscribe)
												|| r
									...
									function s(t) {
										return r.isFunction(t.unsubscribe)
												|| r
														.isFunction(t.removeEventListener)
												|| r.isFunction(t.off)
									}
								};
								...
								a.prototype.on = function(t, e) {
									var i = this._adUnit.addEventListener
											|| this._adUnit.subscribe
											|| this._adUnit.on;
									i.call(this._adUnit, t, e)
								};
								a.prototype.off = function(t, e) {
									var i = this._adUnit.removeEventListener
								...
								a.prototype.handshakeVersion = function(t, e) {
									this.adUnitAsyncCall("handshakeVersion", t,
											e)
								};
								...
								[ "adLinear", "adWidth", "adHeight",
										"adExpanded", "adSkippableState",
										"adRemainingTime", "adDuration",
										"adVolume", "adCompanions", "adIcons" ]
										.forEach(function(t) {
								...
								function l(t, e) {
									...
									function i(t) {
										if (!t || !s.isString(t.src)) {
											throw new r(
													"on VPAIDFlashTech, invalid MediaFile")
										}
									}
								}
								l.VPAIDFLASHClient = a;
								l.supports = function(t) {
									return n.flash.indexOf(t) > -1
											&& l.VPAIDFLASHClient.isSupported()
								};
								l.prototype.loadAdUnit = function c(t, e, i) {
									var n = this;
									var a = this.settings
											&& this.settings.vpaidFlashLoaderPath ? {
								...
								l.prototype.unloadAdUnit = function() {
									if (this.vpaidFlashClient) {
										try {
											...
											u
													.error("VAST ERROR: trying to unload the VPAID adunit")
										}
										this.vpaidFlashClient = null
									}
									if (this.containerEl) {
					...
					33 : [
							function(t, e, i) {
								...
								l.prototype.loadAdUnit = function d(t, e, i) {
									...
									this.containerEl = t;
									this.videoEl = e;
									this.vpaidHTMLClient = new l.VPAIDHTML5Client(
											t, e, {});
									this.vpaidHTMLClient.loadAdUnit(
											this.mediaFile.src, i);

									function n(t, e, i) {
										if (!o.isDomElement(t)) {
											throw new r(
													l.INVALID_DOM_CONTAINER_EL)
										}
										if (!o.isDomElement(e)
								...
								l.INVALID_MEDIA_FILE = c
										+ ", invalid MediaFile";
								l.INVALID_DOM_CONTAINER_EL = c
										+ ", invalid container HtmlElement";
								l.INVALID_DOM_VIDEO_EL = c
										+ ", invalid HTMLVideoElement";
								l.MISSING_CALLBACK = c
										+ ", missing valid callback";
								e.exports = l
							}, {
								"../../utils/consoleLogger" : 41,
								"../../utils/dom" : 42,
					...
					34 : [
							function(t, e, i) {
								...
								p.prototype.playAd = function g(t, e) {
									...
									var n = this.player;
									h
											.debug("<VPAIDIntegrator.playAd> looking for supported tech...");
									var s = this._findSupportedTech(t,
											this.settings);
									e = e || f.noop;
									this._adUnit = null;
									...
									if (s) {
										h
												.info(
														"<VPAIDIntegrator.playAd> found tech: ",
														s);
										l.waterfall(
												[
														function(e) {
										...
										h
												.debug("<VPAIDIntegrator.playAd> could not find suitable tech");
										var o = new r(
								...
								p.prototype._createVPAIDAdUnitWrapper = function(
										t, e, i) {
									return new u(t, {
										src : e,
										responseTimeout : i
								...
								p.prototype._loadAdUnit = function(t, e, i) {
									...
									var s = this.settings.responseTimeout
											|| this.options.responseTimeout;
									t.loadAdUnit(this.containerEl, a, function(
											a, o) {
										if (a) {
											return i(a, o, e)
										}
								...
								p.prototype._initAd = function(t, e, i) {
									var n = this.player.el().querySelector(
											".vjs-tech");
									var r = c.getDimension(n);
									t.initAd(r.width, r.height,
											this.VIEW_MODE.NORMAL, -1, {
								...
								p.prototype._setupEvents = function(t, e, i) {
									...
									t
											.on(
													...
													function() {
														a
																.trigger("vpaid.AdVideoFirstQuartile");
									...
									t
											.on(
													...
													function() {
														a
																.trigger("vpaid.AdUserAcceptInvitation");
														r
								...
								p.prototype._addSkipButton = function(t, e, i) {
									...
									function a() {
										r
												.trigger("vpaid.AdSkippableStateChange");
								...
								p.prototype._linkPlayerControls = function(t,
										e, i) {
									var n = this;
									r(this.player, t);
								...
								function v(t, e, i) {
									...
									var r = c.getDimension(n);
									var a = t.isFullscreen() ? i.FULLSCREEN
											: i.NORMAL;
										...
										init : function e(i, a) {
											...
											setTimeout(
													function() {
														var t = i.controlBar
																&& (i.controlBar
																		.getChild("timerControls") || i.controlBar
					...
					36 : [
							function(t, e, i) {
								...
								var r = t("./ads-label")(n);
								videojs.registerComponent("AdsLabel", videojs
										.extend(n, r))
							}, {
								"./ads-label" : 35
							} ],
					...
					38 : [
							function(t, e, i) {
								...
								videojs.registerComponent("BlackPoster",
										videojs.extend(n, r))
							}, {
								"./black-poster" : 37
							} ],
					39 : [
							function(t, e, i) {
								...
								e.exports = function h(t) {
									...
									a
											.runFlashSupportCheck(y.vpaidFlashLoaderPath);
									c.prepareForAds(i);
									if (y.playAdAlways) {
									...
									function g() {
										...
										c.once(i, [ "vast.adsCancel",
												"vast.adEnd" ], function() {
											t();
											n()
										});
										u.waterfall([ s, o, h, A ], function(t,
												e) {
											if (t) {
												b(t, e)
											} else {
										...
										function f() {
											return !d.isIPhone()
													|| i.currentTime() <= y.iosPrerollCancelTimeout
										}
									...
									function k(t) {
										h.getVASTResponse(y.adTagUrl ? y
												.adTagUrl() : y.adTagXML, t)
									}
					...
					40 : [
							function(t, e, i) {
								...
								r.when = function(t, e) {
									if (!n.isFunction(e)) {
										throw new Error(
												"async.when error: missing callback argument")
									}
							...
							function(t, e, i) {
								...
								r.hasClass = function c(t, e) {
									...
									if (n.isNotEmptyString(e)) {
										...
										i = n.isString(t.getAttribute("class")) ? t
					...
					43 : [
							function(t, e, i) {
								...
								function a(t) {
									this.message = "HttpRequest Error: "
											+ (t || "")
								}
								...
								function s(t) {
									if (!r.isFunction(t)) {
										throw new a(
												"Missing XMLHttpRequest factory method")
									}
									this.createXhr = t
								}
								s.prototype.run = function(t, e, i, s) {
									...
									function c(t, e, i) {
										...
										if (!r.isFunction(e)) {
											throw new a("Invalid handler '" + e
													+ "' for the http request")
										}
										if (r.isDefined(i) && !r.isObject(i)) {
											throw new a("Invalid options map '"
													+ i + "'")
										}
									}
								...
								function s(t) {
									...
									return {
										...
										hash : r.hash ? r.hash
												.replace(/^#/, "") : "",
										hostname : r.hostname,
										port : n.isNotEmptyString(r.port) ? r.port
												: 80,
					...
					47 : [
							function(t, e, i) {
								...
								function y(t) {
									...
									return j.isString(t) || j.isArray(t)
											|| e === 0 || typeof e === "number"
											&& e > 0 && e - 1 in t
								}
								...
								function D() {
									var t = j
											.getInternetExplorerVersion(navigator);
									if (t === -1) {
										return false
									}
									return t < 10
								...
								function R() {
									return /iP(hone|ad|od)|Android|Windows Phone/
											.test(j._UA)
								}
					...
					48 : [
							function(t, e, i) {
								...
								r.strToXMLDoc = function a(t) {
									...
									function r(t) {
										try {
											var e = new DOMParser, i = e
													.parseFromString("INVALID",
															"text/xml"), n = i
											...
											return t.getElementsByTagNameNS(n,
								...
								r.JXONTree = function o(t) {
									...
									var l = typeof t.hasAttributes === "undefined" ? t.attributes.length > 0
											: t.hasAttributes();
									if (l) {
										var c;
										for (var d = 0; d < t.attributes.length; d++) {
											c = t.attributes.item(d);
											this["@" + n.decapitalize(c.name)] = e(c.value
													.trim())
										}
									}
								};
